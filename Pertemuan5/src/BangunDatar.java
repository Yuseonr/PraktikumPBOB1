...
public abstract class BangunDatar implements IResize {
    ...
    // Method abstrak untuk menghitung luas BangunDatar
    public abstract double getLuas();

    // Method abstrak untuk menghitung keliling BangunDatar
    public abstract double getKeliling();

    // Method untuk membandingkan luas BangunDatar dengan BangunDatar lain
    public boolean isEqualLuas(BangunDatar bd) {
        return this.getLuas() == bd.getLuas();
    }

    // Method untuk membandingkan keliling BangunDatar dengan BangunDatar lain
